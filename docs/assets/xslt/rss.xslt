...
<xsl:template match="/rss">
	...
	<link rel="icon" sizes="32x32" href="http://localhost:4000/assets/img/OEDIcon22x32.png">

	<link rel="icon" sizes="192x192" href="http://localhost:4000/assets/img/OEDIcon192x274.png">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar data-options="scrolltop: false">
    <ul class="title-area">
      <li class="name">
      <h1 class="hide-for-large-up"><a href="http://localhost:4000" class="icon-tree"> Open Energy Dashboard</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000">FEATURES</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/features/">FEATURES BY TYPE</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/useAcademic/">FEATURES BY ACADEMIC USE</a></li>
              ...
              <li><a  href="http://localhost:4000/helpV1.1.0/index/">Documentation</a></li>
              <li class="divider"></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="Open Energy Dashboard – A Free, Open Source Energy/Resource Dashboard">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Open Energy Dashboard – A Free, Open Source Energy/Resource Dashboard">
			</a>
